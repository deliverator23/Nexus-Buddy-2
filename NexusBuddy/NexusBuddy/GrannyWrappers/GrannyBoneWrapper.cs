...
namespace NexusBuddy.GrannyWrappers
{
    public unsafe class GrannyBoneWrapper
    {
        ...
        public float[] getPosition()
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                matrixValue[j] = *(float*)((IntPtr)m_pkBone + 12 + (j * 4));
            }
        ...
        public float[] getOrientation()
        {
            ...
            for (int j = 0; j < 4; j++)
            {
                matrixValue[j] = *(float*)((IntPtr)m_pkBone + 24 + (j * 4));
            }
        ...
        public void setScaleShear(float[] scaleShear)
        {
            for (int j = 0; j < 9; j++)
            {
                *(float*)((IntPtr)m_pkBone + 40 + (j * 4)) = scaleShear[j];              
            }
        }
        ...
        public float[] getScaleShear()
        {
            ...
            for (int j = 0; j < 9; j++)
            {
                matrixValue[j] = *(float*)((IntPtr)m_pkBone + 40 + (j * 4));
            }
        ...
        public float[] getInverseWorldMatrix()
        {
            ...
            for (int j = 0; j < 16; j++)
            {
                matrixValue[j] = *(float*)((IntPtr)m_pkBone + 76 + (j * 4));
            }
