...
{
	internal class IndieLeaderTransparencyShader : IndieMaterial
	{
        ...
        [Category("Leaderhead Materials"), DisplayName("TransparencyMap"), Editor(typeof(FilteredFileNameEditor), typeof(UITypeEditor))]
		...
		public IndieLeaderTransparencyShader(IGrannyMaterial material) : base(material)
		{
		}
		public void CopyTextures(string outputFolder)
		{
            ...
            base.CopyTextureIfExists(this.TransparencyMap, outputFolder);
		}
	}
}
